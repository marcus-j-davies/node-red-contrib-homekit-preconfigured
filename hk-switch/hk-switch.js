module.exports = function (RED)
{
    function Init(config)
    {
        ...
        const UUID = uuid.generate('hap-nodejs:accessories:switch:' + config.name);
        ...
        // Main Service
        const service = accessory.addService(Service.Switch, config.name, config.name);
    ...
    RED.nodes.registerType("hk-switch", Init);
