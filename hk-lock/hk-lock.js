module.exports = function (RED)
{
    function Init(config)
    {
        ...
        const UUID = uuid.generate('hap-nodejs:accessories:lock:' + config.name);
        ...
        // Main Service
        const service = accessory.addService(Service.LockMechanism, config.name, config.name);
    ...
    RED.nodes.registerType("hk-lock", Init);
