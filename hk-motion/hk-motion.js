module.exports = function (RED)
{
    function Init(config)
    {
        ...
        const UUID = uuid.generate('hap-nodejs:accessories:motionsensor:' + config.name);
        ...
        // Main Service
        const service = accessory.addService(Service.MotionSensor, config.name, config.name);
        ...
        service.getCharacteristic(Characteristic.MotionDetected)
            .on(CharacteristicEventTypes.GET, function (callback) { Get("MotionDetected", callback) });
    ...
    RED.nodes.registerType("hk-motion", Init);
